...
Run ID: h1-tree-20260418-170747  
Status: kill
...
| 2 | 2023-03-23 to 2026-03-13 | +0.0358 | -0.1949 | +1.1972 | -0.1690 | -1.3922 | -0.373 | -1.548 | -0.2147 | 0.483 | +0.4871 | volume_spike | fail |

## 6. Aggregate Metrics

- **Mean gross return**: +0.0119
- **Mean net return**: -0.0650
- **Mean net benchmark gap**: -1.1307
- **Mean net Sharpe**: -0.124
- **Mean benchmark Sharpe gap**: -1.183
- **Primary predictive metric (mean)**: +0.1624
- **Stability CV**: 1.414
...
**Reason**:  
Event-driven H1 using market proxy tags produced mean net benchmark gap -1.1307, recent-window gap -1.3922, and did not satisfy the 2/3 benchmark rule.
