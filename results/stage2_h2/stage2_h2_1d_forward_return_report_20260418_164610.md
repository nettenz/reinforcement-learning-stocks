...
- **Target variant**: 1d_forward_return
- **Model family**: tree
...
|--------|--------|--------------|------------|-----------------|-----------------|-------------------|------------|----------------------|--------|----------|-------------------|---------|
| 0 | 2019-12-20 to 2022-12-05 | +0.6640 | +0.4215 | +0.4566 | -0.2945 | -0.0351 | +0.552 | +0.017 | -0.2853 | 0.302 | -0.1508 | fail |
| 1 | 2021-08-06 to 2024-07-24 | +0.2373 | +0.1416 | +0.3214 | -0.0686 | -0.1798 | +0.312 | -0.147 | -0.4695 | 0.155 | -0.4354 | fail |
| 2 | 2023-03-23 to 2026-03-12 | +0.4869 | +0.2509 | +1.2406 | -0.0939 | -0.9897 | +0.489 | -0.715 | -0.2886 | 0.332 | -0.1906 | fail |

## 5. Aggregate Metrics

- **Mean gross return**: +0.4627
- **Mean net return**: +0.2713
- **Mean net benchmark gap**: -0.4016
- **Mean net Sharpe**: +0.451
- **Mean benchmark Sharpe gap**: -0.282
- **Primary predictive metric (mean)**: -0.2589
- **Stability CV**: 0.424
...
**Reason**:  
H2 target variant '1d_forward_return' with best family 'tree' produced mean net benchmark gap -0.4016 and recent-window gap -0.9897.
